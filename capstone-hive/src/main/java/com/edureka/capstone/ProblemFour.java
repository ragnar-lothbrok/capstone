...
public class ProblemFour {
	...
	private static final Logger logger = LoggerFactory.getLogger(ProblemFour.class);
	...
	static class MerchantGenderMonthly {
		...
		public String toString() {
			return "MerchantGenderMonthly [merchant=" + merchant + ", gender=" + gender + ", month=" + month
	...
	public static void solveProblem(Properties props) {
		...
		try {
			...
			while (rs.next()) {
				MerchantGenderMonthly merchantSegmentMonthly = new MerchantGenderMonthly();
		...
		logger.info("Monthly wise merchant gender stats = {} ", list);
	}
