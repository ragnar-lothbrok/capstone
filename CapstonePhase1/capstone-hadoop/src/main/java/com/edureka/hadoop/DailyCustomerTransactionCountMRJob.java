...
import com.edureka.hadoop.model.CustomerKey;
import com.edureka.hadoop.model.CustomerWritable;
import com.edureka.hadoop.model.Transaction;
import com.google.gson.Gson;

public class DailyCustomerTransactionCountMRJob {

	public static class TransactionMapper extends Mapper<Object, Text, CustomerWritable, AggregateWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			customerKey.setDate(sdf.format(cal.getTime()));
			customerKey.setCustomerKey(transaction.getCustomerId());

			context.write(new CustomerWritable(customerKey), aggregateWritable);
		}

	}

	public static class TxAggregator extends Reducer<CustomerWritable, AggregateWritable, CustomerWritable, AggregateWritable> {

		public void reduce(CustomerWritable key, Iterable<AggregateWritable> values, Context context)
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(DailyCustomerTransactionCountMRJob.class);
